...
public static enum TableNames{
	uLocations, yetAnotherSqlliteTablename;
}
...
//	final android.content.SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContext);
	...
	String ServerIPaddr = prefs.getString( "ServerIPaddr",
	                                       pkUtil.getPropertiesFromAssets(
			                                       ConnectionPropertiesFname )
...
public TableNames toTableNames( final Uri uri ){
	...
	try{ return TableNames.valueOf( uri.getFragment() ); }catch ( IllegalArgumentException e ){
