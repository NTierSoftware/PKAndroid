...
public final class PRNGFixes {
    ...
    private static void applyOpenSSLFix() throws SecurityException {
        if ((android.os.Build.VERSION.SDK_INT < VERSION_CODE_JELLY_BEAN)
                || (android.os.Build.VERSION.SDK_INT > VERSION_CODE_JELLY_BEAN_MR2)) {
    ...
    private static void installLinuxPRNGSecureRandom()
        ...
        if (android.os.Build.VERSION.SDK_INT > VERSION_CODE_JELLY_BEAN_MR2) {
            // No need to apply the fix
            return;
        }
        ...
        java.security.Provider[] secureRandomProviders =
                java.security.Security.getProviders("SecureRandom.SHA1PRNG");
        if ((secureRandomProviders == null)
                || (secureRandomProviders.length < 1)
                || (!org.peacekeeper.tutorial.PRNGFixes.LinuxPRNGSecureRandomProvider.class.equals(
                        secureRandomProviders[0].getClass()))) {
            java.security.Security.insertProviderAt(new org.peacekeeper.tutorial.PRNGFixes.LinuxPRNGSecureRandomProvider(), 1);
        }
        ...
        if (!org.peacekeeper.tutorial.PRNGFixes.LinuxPRNGSecureRandomProvider.class.equals(
    ...
    private static class LinuxPRNGSecureRandomProvider extends java.security.Provider {
		...
		public LinuxPRNGSecureRandomProvider() {
            ...
            put("SecureRandom.SHA1PRNG", org.peacekeeper.tutorial.PRNGFixes.LinuxPRNGSecureRandom.class.getName());
    ...
    public static class LinuxPRNGSecureRandom extends java.security.SecureRandomSpi {
        ...
        protected void engineSetSeed(byte[] bytes) {
            try {
                ...
                // Log and ignore.
                android.util.Log.w(org.peacekeeper.tutorial.PRNGFixes.class.getSimpleName(),
        ...
        private java.io.DataInputStream getUrandomInputStream() {
            synchronized (sLock) {
                if (sUrandomIn == null) {
                    ...
                    try {
                        sUrandomIn = new java.io.DataInputStream(
                                new java.io.FileInputStream(URANDOM_FILE));
                    } catch (java.io.IOException e) {
        ...
        private java.io.OutputStream getUrandomOutputStream() throws java.io.IOException {
            synchronized (sLock) {
                if (sUrandomOut == null) {
                    sUrandomOut = new java.io.FileOutputStream(URANDOM_FILE);
                }
                return sUrandomOut;
            }
        }
    ...
    private static byte[] generateSeed() {
        try {
            ...
            java.io.DataOutputStream seedBufferOut =
                    new java.io.DataOutputStream(seedBuffer);
    ...
    private static String getDeviceSerialNumber() {
        ...
        try {
            return (String) android.os.Build.class.getField("SERIAL").get(null);
